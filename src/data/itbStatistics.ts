 ...
 * Generated at: 2026-05-02T09:41:34.000Z
 *
...
export interface StatusCount {
  ...
  cuti: number;
  other: number;
  otherStatusMap: { [status: string]: number };
}
...
export function getBatchSummary(batch: number): string | null {
  ...
  if (stats.statusBreakdown.nonAktif > 0)
    parts.push(`${stats.statusBreakdown.nonAktif} non-aktif`);
...
export function getProdiBatchSummary(
  ...
  if (stats.statusBreakdown.nonAktif > 0)
    statusParts.push(`${stats.statusBreakdown.nonAktif} non-aktif`);
